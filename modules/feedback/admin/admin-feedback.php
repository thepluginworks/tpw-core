...
<div class="tpw-admin-ui"><div class="wrap">
    ...
    <div style="display: flex; flex-wrap: wrap; gap: 30px; margin-bottom: 30px;">
        <div style="text-align: center;">
            <h3>Ease of Use</h3>
            <canvas id="easeChart" style="max-width: 300px;"></canvas>
        </div>
        <div style="text-align: center;">
            <h3>Clarity of Instructions</h3>
            <canvas id="clarityChart" style="max-width: 300px;"></canvas>
        </div>
        <div style="text-align: center;">
            <h3>Time to Complete</h3>
            <canvas id="timeChart" style="max-width: 300px;"></canvas>
        </div>
    </div>
        ...
        <tbody id="tpw-feedback-table">
            <?php foreach ($results as $row): ?>
                <tr>
                    ...
                    <td>
                        <?php
                        echo match ((int) $row->time_under_2min) {
                            1 => 'Under 2min',
                            0 => '2–5min',
                            2 => 'Over 5min',
                            default => 'N/A'
