      ...
      <form id="tpw-notice-form">
        ...
        <div class="tpw-field">
          ...
          <div class="tpw-inline-add-cat" style="margin-top:8px; display:flex; gap:8px; align-items:center; flex-wrap:wrap;">
            ...
            <button type="button" class="button" id="tpw_add_category_btn"><?php echo esc_html__('Add Category','tpw-core'); ?></button>
        ...
        <div class="tpw-field">
          ...
          <div class="tpw-media-picker">
            ...
            <button class="button tpw-pick-image" type="button"><?php echo esc_html__('Choose Image','tpw-core'); ?></button>
        ...
        <div class="tpw-actions">
          <button type="submit" class="button button-primary"><?php echo esc_html__('Save Notice', 'tpw-core'); ?></button>
        </div>
      </form>
    </div>
  </div>
