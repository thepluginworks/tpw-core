...
<section id="flexiclub-menu-management-overview" class="tpw-flexiclub-dashboard__hero tpw-card tpw-flexiclub-control-workspace__hero">
	<div class="tpw-flexiclub-dashboard__brand-row tpw-flexiclub-control-workspace__hero-head">
		<div class="tpw-flexiclub-dashboard__welcome tpw-flexiclub-control-workspace__hero-copy">
			...
			<p><?php echo esc_html( $workspace['hero_copy'] ?? __( 'Manage the current front-end menu permissions tools from the FlexiClub portal.', 'tpw-core' ) ); ?></p>
		</div>
...
<section id="flexiclub-menu-management-tool" class="tpw-flexiclub-dashboard__section tpw-card tpw-flexiclub-control-workspace__section">
	<div class="tpw-flexiclub-dashboard__section-head tpw-flexiclub-control-workspace__section-head">
		<div>
			...
			<p><?php echo esc_html( $workspace['tool_copy'] ?? __( 'This workspace embeds the existing front-end menu-management section inside the FlexiClub portal shell.', 'tpw-core' ) ); ?></p>
		</div>
	</div>
