# FlexiClub Settings — Admin Guide

This page explains the settings available under WordPress → Settings → FlexiClub.

## Features

- Default Login Page
  - What it does: Defines the page members should be redirected to when login is required on FlexiClub pages and features.
  - Where used: FlexiEvent and other FlexiClub add-ons read this value to send users to the correct login screen.
...
Controls UI theme tokens used in FlexiClub admin UIs and buttons. Adjust font, weights, colours, and button styles.
...
Notes
- All FlexiClub add-ons consult the Default Login Page for redirecting users who need to sign in.
